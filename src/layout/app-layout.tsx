...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Billings', path: '/billings', entity: 'billing', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    ...
    { name: 'Sales', path: '/sales', entity: 'sale', service: AccessServiceEnum.PROJECT, icon: FiShoppingCart },
